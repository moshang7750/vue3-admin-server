<template>
  <div class="af-user">
    ...
    <el-table :data="tableData" style="width: 100%">
      ...
      <el-table-column prop="userGroupName" label="所在组" sortable>
      </el-table-column>
...
import { UserFilter, UserTable, UserStatus } from '@/types/jurisdiction.type'
import { useMethons } from '@/libs/useMethons'
export default defineComponent({
  components: { Tabs },
  setup(props) {
    const tabData = ref([{ name: '用户管理', type: 1 }])
    // 筛选框
    const params: UserFilter = reactive({
      username: '',
      email: '',
      phone: '',
      page: 1,
    ...
    const tableData: Ref<UserTable[]> = ref([
      {
        id: '111',
        username: '张三',
        email: 'sxxx@qq.com',
