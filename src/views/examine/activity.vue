...
import { ActiveCompontFilter, ActiveCompontTable } from '@/types/examine.types'
import { useMethons } from '@/libs/useMethons'
export default defineComponent({
  setup(props) {
    // 筛选框
    const params: ActiveCompontFilter = reactive({
      activeType: '',
      activeName: '',
      page: 1,
      size: 10,
    ...
    const tableData: Ref<ActiveCompontTable[]> = ref([
      {
        id: '111',
        activeType: 1,
        activeTypeName: '线下活动',
