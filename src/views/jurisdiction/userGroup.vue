  ...
  <div class="af-userGroup">
    ...
    <div class="af-filter-warp">
      <div class="af-warp-left">
        <el-input v-model="params.userGroupName" placeholder="请输入用户组名" />
    ...
    <el-table :data="tableData" style="width: 100%">
      <el-table-column prop="id" label="用户组ID" sortable> </el-table-column>
      <el-table-column prop="userGroupName" label="用户组名" sortable>
      </el-table-column>
      <el-table-column prop="memberNums" label="成员" sortable>
      </el-table-column>
...
export default defineComponent({
  components: { Tabs },
  setup(props) {
    const tabData = ref([{ name: '用户组', type: 1 }])
    // 筛选框
